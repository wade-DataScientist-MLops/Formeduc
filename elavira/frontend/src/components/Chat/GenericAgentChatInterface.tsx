...
interface GenericAgentChatInterfaceProps {
  agentId: string;
  agentName: string;
  agentRole: string;
...
export const GenericAgentChatInterface: React.FC<GenericAgentChatInterfaceProps> = ({
  agentId,
  agentName,
  agentRole,
  agentDescription
    ...
    <ChatContainer>
      ...
      <MessagesContainer>
        ...
        {messages.map((message) => (
          <MessageBubble key={message.id} isUser={!message.user_id.includes('Assistant')}>
            {message.text}
            <MessageTime isUser={!message.user_id.includes('Assistant')}>
